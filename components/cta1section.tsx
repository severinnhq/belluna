        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          <div className="flex-1 w-full min-w-[280px]"> {/* Added min-width */}
            <div className="bg-white/10 backdrop-blur-xs backdrop-brightness-105 rounded-2xl p-6 md:p-8 my-shadow"> {/* Responsive padding */}
              ...
              <button
                onClick={scrollToTop}
                className="text-base md:text-lg lg:text-xl px-4 py-3 md:px-6 md:py-4 bg-yellow-400 text-white hover:bg-yellow-500 hover:text-black btn-shadow font-bold rounded-xl hover:-translate-y-1 transition w-full cursor-pointer"
              >
